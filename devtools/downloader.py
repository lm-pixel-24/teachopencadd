...
RAW_BASE = (
    f"https://raw.githubusercontent.com/{OWNER}/{REPO}"  # raw base -> /{branch}/{path}
)
OUTPUT_DIR = f"./"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=f"Git branch to download from (default: {DEFAULT_BRANCH}).",
    )
    parser.add_argument(
        "--output_dir", "-o", default=OUTPUT_DIR, help="download location."
    )
